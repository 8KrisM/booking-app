...
const Navbar = () => {
    ...
    const UserNavButton = () => {
      return (
        <Link to={user?"/account":"/login"} className='flex items-center border gap-2 border-gray-300 rounded-2xl py-2 px-3 shadow-lg'>
  ...
  return (
    <header className='w-full space-y-2 md:justify-between flex flex-col'>
      ...
      <div className='relative w-full'>
        ...
        <NavbarSearch />:
        (<>
            <div className='input-area shadow-lg font-bold' onClick={()=>setShowSearch(prev=>!prev)}>{showSearch?
